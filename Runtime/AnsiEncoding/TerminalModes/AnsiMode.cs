...
namespace HamerSoft.PuniTY.AnsiEncoding.TerminalModes
{
    ...
    public enum AnsiMode : ulong
    {
        ...
        EnableFontShiftingFunctions = 21,
        ...
        NationalReplacementCharacters =  25,
        ...
        DoNotClearScreenWhenDECCOLM = 38,
        ...
        SendMouseX_YOnButtonPressAndRelease = 39,
        ...
        /// </summary>
        SpecialModifiersAltAndNumLockKeys = 53,
        /// <summary>
        ...
        EnableSwitchingAlternateScreenBuffer = 63,
        /// <summary>
